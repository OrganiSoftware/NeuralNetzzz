                ...
                if layer_index == 0:
                    ...
                    for weight_index in range(len(self.neural_net.neural_net[index].neural_layer[perceptron_index].weights)):
                        ...
                        for del_cost in del_costs_matrix[perceptron_index]:
                            ...
                            temp_del_weight += self.neural_net.neural_net[index].neural_layer[perceptron_index
                                                   ].comp_partial_for_mse_cost(weight_index, False, del_cost)
                        ...
                        del_weights.append(temp_del_weight/len(del_costs_matrix[perceptron_index]))
                        if weight_index == 0:
